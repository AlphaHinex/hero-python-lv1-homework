...
def componentPaint():
    ...
    fillTex('SCORE:'+str(GameVar.score), (0, 0))
    fillTex('LIFE:'+str(GameVar.heroes), (380, 0))
...
class GameVar():
    ...
    score = 0
    heroes = 100000000000000

def fillTex (text, posintion):
    fon = pygame.font.SysFont('微软雅黑', 40)
    newFont = font.render(text, True, (255, 255, 255))
    canvas.blit(newFont, posintion)
#创建游戏退出事件处理方法
def handleEvent():
